...
const Footer = () => {
  return (
    <nav
      className={cn(
        styles.paddingX,
        "w-full flex items-center py-8 bg-primary border-t border-t-gray-100"
      )}
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        <p className="text-[#0f172a] text-md font-bold flex">
          &copy; Pranit Chilbule {new Date().getFullYear()}. All rights reserved.
        </p>
