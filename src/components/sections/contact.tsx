...
import { EarthCanvas, MathEquationsBg } from "../../components";
...
export const Contact = () => {
  ...
  return (
    <SectionWrapper idName="contact" className="relative">
      <MathEquationsBg />
      <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
        <motion.div
          variants={slideIn("left", "tween", 0.2, 1)}
          className="flex-[0.75] bg-[#f8fafc] p-8 rounded-2xl border border-[#e2e8f0]"
        >
          {/* Title */}
          ...
          >
            ...
            <label htmlFor="name" className="flex flex-col">
              ...
              <input
                ...
                className="bg-white border border-[#e2e8f0] py-4 px-6 placeholder:text-[#94a3b8] text-[#0f172a] rounded-lg outline-none font-medium disabled:bg-gray-50 disabled:text-gray-400"
              />
            ...
            <label htmlFor="message" className="flex flex-col">
              ...
              <textarea
                ...
                disabled={loading}
                aria-disabled={loading}
                className="bg-white border border-[#e2e8f0] py-4 px-6 placeholder:text-[#94a3b8] text-[#0f172a] rounded-lg outline-none font-medium disabled:bg-gray-50 disabled:text-gray-400 disabled:resize-none"
              />
            ...
            <button
              ...
              className="bg-[#0f172a] py-3 px-8 outline-none w-fit text-white font-bold shadow-md rounded-xl hover:bg-[#1e293b] transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
              disabled={loading}
              aria-disabled={loading}
            >
              {/* check loader state */}
